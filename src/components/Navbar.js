...
function Navbar ({position}) {
    return (
        <div className="menu-container">
            ...
            <li><NavLink onClick={() => position("oblivion")} to="/oblivion"  id="oblivion" tabIndex="2">Oblivion 3000</NavLink></li>
            <li><NavLink onClick={() => position("proyectos")} to="/proyectos"  id="proyectos" tabIndex="3">Proyectos</NavLink></li>
